package com.demo.jaden.employapplication.network.handler;
...
import com.demo.jaden.employapplication.network.bean.CallbackMessage;
import com.demo.jaden.employapplication.network.bean.DownloadMessage;
import com.demo.jaden.employapplication.network.bean.ProgressMessage;
...
import com.demo.jaden.employapplication.network.callback.CallbackOk;
                ...
                case RESPONSE_CALLBACK://网络请求
                    ...
                    if(null != callMsg.callback){
                        ...
                        if(!BaseActivityLifecycleCallbacks.isActivityDestroyed(callMsg.requestTag)){
                            ...
                            } else if(callback instanceof com.demo.jaden.employapplication.network.callback.Callback){
                                HttpInfo info = callMsg.info;
                                if(info.isSuccessful()){
                                    ((com.demo.jaden.employapplication.network.callback.Callback)callback).onSuccess(info);
                                }else{
                                    ((com.demo.jaden.employapplication.network.callback.Callback)callback).onFailure(info);
                                }
