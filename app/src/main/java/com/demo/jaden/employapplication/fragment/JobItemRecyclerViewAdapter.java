...
/**
 * {@link RecyclerView.Adapter} that can display a {@link JobItem} and makes a call to the
...
public class JobItemRecyclerViewAdapter extends RecyclerView.Adapter<JobItemRecyclerViewAdapter.ViewHolder> {
    ...
    public JobItemRecyclerViewAdapter(List<JobItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
